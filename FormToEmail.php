...
$message = "I would like to subscribe for more information about Julie Vital!";

$message = $message . PHP_EOL.PHP_EOL."-- ".PHP_EOL."Thank you";

$message = stripslashes($message);

$subject = "Subscribe to Julia Vital";
...
$from_name = "Interested-JuliaVital";
