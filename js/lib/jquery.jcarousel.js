                    ...
                    if (this.inTail) {
                        ...
                        if (start <= 0 && ((this.underflow && wrap === 'circular') || wrap === 'both' || wrap === 'first')) {
                            ...
                            if (this.circular && index <= 0) {
                                ...
                                while (i++ < 0) {
                                    var jcurr = this.items().eq(-1);
                                    isVisible = this._visible.index(jcurr) >= 0;

                                    if (isVisible) {
                                        jcurr.after(jcurr.clone(true).attr('data-jcarousel-clone', true));
                                    }

                                    this.list().prepend(jcurr);

                                    // Force items reload
                                    this._items = null;

                                    var dim = this.dimension(jcurr);
