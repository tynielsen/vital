...
$(window).load(function() {
  ...
  $('.carousel-stage ul li a').fancybox({'padding': 0});

      $('.carousel-stage').on('jcarousel:scrollend', function(event, carousel) {

        var first = $('.carousel-stage').jcarousel('visible');
        
        $('.carousel-stage li').removeClass('visible'); 
      ...
      //Zoom in effect for looks page images
      //$('.generic-popup').zoom({
        //url: 'img/featured-img-3-2.jpg',
        //on: 'click'
      //});
